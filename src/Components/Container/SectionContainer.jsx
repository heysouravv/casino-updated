...
const SectionContainer = ({ heading, desc, children, id }) => {
  return (
    <section className="relative flex flex-col items-center justify-center w-full sm:min-h-screen  bg-bg-primary">
