...
const Testimonial = ({ message, name }) => {
  return (
    ...
    sm:justify-between min-w-[250px] md:min-w-[543px] py-[38px] px-[46px] hover:bg-gradient-radial hover:from-yellow-700 to-yellow-800 transition duraton-500 hover:scale-105 "
    >
