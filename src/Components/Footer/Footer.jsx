  ...
  return (
    <div className="w-full">
      <footer className="bg-bg-primary dark:bg-[#030303] py-5 lg:py-10 border-t border-[#E7C980]">
        <div className="w-full max-w-screen-xl px-4 mx-auto lg:px-6 lg:py-8">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
              ...
              <div className="flex flex-col items-start justify-start gap-4">
                ...
                <ul className="text-[#ABABAB] text-sm lg:text-base font-bold text-left">
                  <li className="mb-2">
                    <p>Address:</p>
                    <p className="text-xs lg:text-sm font-normal">Hilton Goa Resort, Saipem, Candolim</p>
                  </li>
                  <li className="mb-2">
                    <p>Email:</p>
                    <a href="mailto:info@phoenixcasinogoa.com" className="text-xs lg:text-sm font-normal hover:underline">info@phoenixcasinogoa.com</a>
                  </li>
                  <li className="mb-2">
                    <p>Phone:</p>
                    <a href="tel:+919876543210" className="text-xs lg:text-sm font-normal hover:underline">+91 9876 543 210</a>
                  </li>
                </ul>
              </div>
            </div>
          </div>
          <div className="mt-8 text-center text-xs lg:text-sm text-[#ABABAB]">
            <p>&copy; 2024 Phoenix Casino Goa. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
