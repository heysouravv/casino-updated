          ...
          <div className="lg:flex lg:justify-between">
            <div className="mb-6 lg:mb-0">
              <div className="flex flex-col items-center justify-center gap-4 lg:items-start">
                <img src="/logo.svg" className="h-36" alt="Phoenix Casino Logo" />
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-start justify-start gap-4">
                <h2 className="text-lg font-extrabold leading-normal uppercase lg:text-xl gradient-text">
                  Quick Links
                </h2>
              ...
              <div className="flex flex-col items-start justify-start gap-4">
                ...
                <ul className="text-[#ABABAB] font-bold text-left">
                  <li className="mb-2">
                    <p>Address:</p>
                    <p className="text-sm font-normal">Hilton Goa Resort, Saipem, Candolim</p>
                  </li>
                  <li className="mb-2">
                    <p>Email:</p>
                    <a href="mailto:info@phoenixcasinogoa.com" className="text-sm font-normal hover:underline">info@phoenixcasinogoa.com</a>
                  </li>
                  <li className="mb-2">
                    <p>Phone:</p>
                    <a href="tel:+919876543210" className="text-sm font-normal hover:underline">+91 9876 543 210</a>
                  </li>
                </ul>
              </div>
            </div>
          </div>
          <div className="mt-8 text-center text-sm text-[#ABABAB]">
